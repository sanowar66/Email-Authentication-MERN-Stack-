...
function ResetPassword() {
  ...
  return (
    <div className="flex mt-3 justify-center  items-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      <img
        onClick={() => navigate("/")}
        src={assets.logo}
        alt=""
      ...
      {!isEmailSent && (
        ...
        >
          ...
          <p className="text-center mb-6 text indigo-300 text-white">
